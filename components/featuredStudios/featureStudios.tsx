                ...
                >
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="mt-5 flex items-center gap-4">
                            {/* Waveform — inline equalizer mark, not an absolutely-positioned afterthought */}
                            <div
                                aria-hidden="true"
                            ...
                            <h2
                                ...
                                "
                            >
                                <span className=" text-xl block text-[#fff]">
                                    Record in
                                </span>
                                ...
                                <span className="relative inline-block">
                                    ...
                                    <svg
                                        ...
                                        className="absolute -bottom-2 left-0 h-3 w-full text-blue-500 lg:-bottom-3"
                                    >
                                        <path
